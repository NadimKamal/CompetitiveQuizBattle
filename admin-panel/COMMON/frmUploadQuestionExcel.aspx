<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmUploadQuestionExcel.aspx.cs" Inherits="COMMON_frmUploadQuestionExcel" %>
...
<head id="Head1" runat="server">
  ...
  <body style="background-color: lightgrey;">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <Triggers>
        <asp:PostBackTrigger ControlID="saveExcel" />
                                                ...
                                                <table>
                                                    <tr>
                                                        <td class="auto-style6">
                                                            <asp:Label ID="Label46" runat="server" Text="Upload Excel File"></asp:Label>
                                                        </td>
                                                        
                                                        <td class="auto-style8">
                                                            <asp:FileUpload ID="uploadExclForPending" runat="server"  />
                                                        </td>
                                                    </tr>
                                                    <tr>
                        ...
                        <asp:DropDownList ID="ddlSub" runat="server" AutoPostBack="true" EnableViewState="true" OnSelectedIndexChanged="OnSelectedIndexChanged_sub"> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="auto-style5">
                                                            <asp:Button ID="btnExcelUpload" runat="server" OnClick="btnExcelUpload_Click" Text="Upload" />
                                                        </td>
                                                    </tr>
                                                     <tr>
                                        <td style="background-color: powderblue;" class="auto-style2" colspan="3">
                                            <strong>
                                                <span style="color: black">
                                                   Save Excel File 
                                                    <asp:Label ID="lblMessage9" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label>
                                                </span>
                                            </strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style2" colspan="3">
                                            <table>
                                                <tr><td class="auto-style4" valign="top">
                                            <asp:Label ID="Label47" runat="server" Text="Excel File"></asp:Label>
                                                    </td><td valign="top">:</td><td>
                                            <asp:TextBox ID="txtExcelFied" runat="server" Enabled="False" TextMode="MultiLine" Width="180px"></asp:TextBox>
                                                    </td></tr>
                                                <tr><td class="auto-style4">
                                                    &nbsp;</td><td></td><td>
                                            <asp:Button ID="saveExcel" runat="server" Text="Save" OnClick="saveExcel_Click" />
                                            </td></tr></table>
                                        </td>
                                    </tr>
                                                </table>
