<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAddDept.aspx.cs" Inherits="COMMON_frmAddDept" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlTop" runat="server" CssClass="Top_Panel" style="background-color: black; color:white">
                <table width="100%">
                    <tr>
                        <td class="style1">
                            <asp:Label ID="Label1" runat="server" Text="Add Department" ></asp:Label>
                            &nbsp;
                        </td>
                        <td>
                        </td>
            ...
            <asp:Panel ID="Panel4" runat="server" CssClass="Top_Panel" style="background-color: black; color:white">
                <table width="100%">
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Text="Department List"></asp:Label>
                            &nbsp;
                        </td>
                    </tr>
                </table>
            ...
            <asp:Panel ID="pnlGridView" runat="server">
                <asp:GridView ID="gdvBranchList" runat="server" AutoGenerateColumns="False" DataKeyNames="SYS_DEPT_ID"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Dept Id" Visible="false">
                            <ItemTemplate>
                                <asp:Label ID="lblBranchId" Visible="false" runat="server" Text='<%#Bind("SYS_DEPT_ID") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        
                        <asp:TemplateField HeaderText="Dept Name" ControlStyle-Width="150">
                            <ItemTemplate>
                                <asp:Label ID="lblBranchName" runat="server" Text='<%#Bind("SYS_DEPT_NAME") %>'></asp:Label>
                            </ItemTemplate>
                              <EditItemTemplate>
                                <asp:TextBox ID="gvtxtBranchName" runat="server" Text='<%#Bind("SYS_DEPT_NAME") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
                      
                        <asp:TemplateField HeaderText="Added By" ControlStyle-Width="200">
                            <ItemTemplate>
                                <asp:Label ID="lblBranchAddress" runat="server" Text='<%#Bind("DEPT_ADDED_BY") %>'></asp:Label>
                            </ItemTemplate>
                           
                        </asp:TemplateField>
                         <asp:TemplateField HeaderText="Addition Date" ControlStyle-Width="200">
                            <ItemTemplate>
                                <asp:Label ID="lblBranchCode" runat="server" Text='<%#Bind("DEPT_ADD_DATE") %>'></asp:Label>
                            </ItemTemplate>
                         ...
                         <asp:TemplateField HeaderText="Dept Type" ControlStyle-Width="150">
                            <ItemTemplate>
                                <asp:Label ID="lblBranchType" runat="server" Text='<%#Bind("SYS_DEPT_TYPE") %>'></asp:Label>
                            </ItemTemplate>
