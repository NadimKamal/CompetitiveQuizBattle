...
require 'connection.php';
    ...
    if($subject_name!="")
    {
        $sql = "INSERT into College_Subject (subject_name) values('$subject_name')";
        $conn->exec($sql);
                ...
                <div class="img-fill">
                    ...
                    <div class="text-content">
                        <div class="dropdown">
                            ...
                            <?php
                                $get_data = "Select * from College_Subject";
                                ...
                                for($i = 0; $i<$cnt; $i++)
                                {
                                    echo "<a href='admin-college-quiz.php?subject=".$result[$i][0]."'>".$result[$i][1]."</a>";
                                }
