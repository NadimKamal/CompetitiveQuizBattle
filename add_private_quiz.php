   ...
   if(isset($_POST["submit"]))
    {
        ...
        $get_data = "SELECT private_id,question_num FROM CreateTournament where created_by='".$createdBy."' order by private_id desc LIMIT 1";
        $conn = Openconnection();
        ...
        $get_data = "SELECT count(*) cnt FROM private_question where private_id='".$privateId."'";
        $conn = Openconnection();
        $qry = sqlsrv_query($conn,$get_data);
        while($result = sqlsrv_fetch_array($qry, SQLSRV_FETCH_ASSOC))
          {
        ...
        $sqlin = "INSERT into private_question (private_id,question_desc,option_a,option_b,option_c,option_d,correct)values($privateId,'$qdesc','$a','$b','$c','$d','$curr')";
        ExecuteNonQuery($sqlin);
                ...
                <div class="QuestionContainer">
                  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
                    <div class="row">
                      ...
                      <div class="col-75">
                        <textarea id="qdesc" name="qdesc" placeholder="Write Question Desc" style="height:100px"></textarea>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-25">
                    ...
                    <div class="row">
                      ...
                      <div class="col-75">
                        <input type="text" id="curr" name="curr" placeholder="Correct Option( Ex: A )">
                      </div>
                    </div>
