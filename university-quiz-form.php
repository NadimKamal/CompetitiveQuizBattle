...
require 'connection.php';
    ...
    $sql = "INSERT into university (dept_id,course_id,question,a,b,c,d,correct) values($dept,$course,'$question','$a','$b','$c','$d','$correct')";
    $conn->exec($sql);
            ...
            <div class="text-content">
                ...
                * {
                ...
                <div class="QuestionContainer">
                 <form class="form form-signup" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?dept='.$_GET['dept'].'&course='.$_GET['course'];?>">
                    <div class="row">
                      <div class="col-25">
