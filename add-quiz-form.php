...
require 'connection.php';
    ...
    $sql = "INSERT into school (class_id,subject_id,question,a,b,c,d,correct) values($class,$subject,'$question','$a','$b','$c','$d','$correct')";
    $conn->exec($sql);
            ...
            <div class="text-content">
                ...
                * {
                ...
                <div class="QuestionContainer">
                  <form class="form form-signup" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?class='.$_GET['class'].'&subject='.$_GET['subject'];?>">
                    <div class="row">
                      <div class="col-25">
